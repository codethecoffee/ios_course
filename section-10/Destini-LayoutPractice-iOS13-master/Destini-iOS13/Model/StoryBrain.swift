...
struct StoryBrain {
    ...
    mutating func nextStory(userChoice: String) {
        let currStory = stories[currStoryNum]
        
        if userChoice == currStory.choice1 {
            self.currStoryNum = currStory.choice1Destination
        }
        else {
            self.currStoryNum = currStory.choice2Destination
        }
    }
